...
# For the logs (sorry for calling it telemetry)
...
class Dashboard(ctk.CTkFrame):
    def __init__(self, master: ctk.CTk, controller: GCSController, **kwargs):
        ...
        self.logs_frame = ctk.CTkFrame(self, fg_color="#1a1a1a")
        self.logs_frame.grid(row=2, column=0, columnspan=3,
                             sticky="nsew", padx=5, pady=5)
        self.logs_frame.grid_columnconfigure(0, weight=5)   # Logs column
        self.logs_frame.grid_columnconfigure(1, weight=1)   # Scanner drone
        self.logs_frame.grid_columnconfigure(2, weight=1)   # Sprayer drone
        ...
        self.sprayer_panel = DronePanel(
            self.logs_frame, "Sprayer Drone", controller)
        self.scanner_panel = DronePanel(
            self.logs_frame, "Scanner Drone", controller)
        ...
        self.sprayer_panel.grid(
            row=0, column=2, rowspan=2, sticky="nsew", padx=5, pady=5)
