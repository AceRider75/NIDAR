        ...
        for i in range(retries):
            ...
            if ack:
                if ack.result == mavutil.mavlink.MAV_RESULT_ACCEPTED:
                    ...
                    print(f"Drone busy, attempt:{i}")
                else:
                    self.log += f"Critical failure. Result code: {ack.result}\n"
                    print(f"Critical failure {ack.result}")
                    return None
