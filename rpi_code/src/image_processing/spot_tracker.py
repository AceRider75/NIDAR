        ...
        with open(telemetry_file, 'a', newline='') as f:
            if _spot_queue:
                ...
                for spot_data in _spot_queue:
                    ...
                    filtered_data = {k: v for k, v in spot_data.items() if k in fieldnames}
        ...
        while True:
            ...
            if telemetry is None:
                ...
                if not hasattr(main, "warned_no_telemetry"):
                    print("Warning: No telemetry data available yet; check that controller/main.py is running and writing telemetry_live.csv")
